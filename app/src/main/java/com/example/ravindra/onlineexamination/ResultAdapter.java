...
//    LayoutInflater layoutInflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (temp.getAns().equals(temp.getA())) {
            option1.setBackgroundColor(context.getColor(R.color.correctAns));
            c1.setVisibility(View.VISIBLE);
        } else if (temp.getAns().equals(temp.getB())) {
            option2.setBackgroundColor(context.getColor(R.color.correctAns));
            c2.setVisibility(View.VISIBLE);
        } else if (temp.getAns().equals(temp.getC())) {
            option3.setBackgroundColor(context.getColor(R.color.correctAns));
            c3.setVisibility(View.VISIBLE);
        } else if (temp.getAns().equals(temp.getD())) {
            option4.setBackgroundColor(context.getColor(R.color.correctAns));
